...
- **Content and classification constraints**
  ...
  - Classification source of truth is `references/classification_specification_v4.md`.
...
- **Narrative and report constraints**
  ...
  - Narrative source of truth is `references/narrative_specification_v3.md`.
...
- **Operational constraints**
  ...
  - Gemini API requests must strictly use the System Instruction pattern to separate authoritative rules from dynamic user payloads.
