...
def _audit_batch(
    ...
    system_instruction, user_prompt = _build_audit_prompts(batch, reference_data)
...
- Every object must have non-empty critique, category_reason, matched_rule, and evidence.
